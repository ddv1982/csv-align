...
test('renders a back navigation button with the icon before the label', () => {
...
test('renders a forward navigation button with the icon after the label and forwards clicks', () => {
